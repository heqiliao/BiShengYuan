 ...
 */
public class XfbTwoYearActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.xuefeibaoxiangqing_two);
        ...
        touzi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(XfbTwoYearActivity.this, PayActivity.class);
