 ...
 */
public class XfbThreeYearActivity extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.xuefeibaoxiangqing_three);
        ...
        touzi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(XfbThreeYearActivity.this, PayActivity.class);
