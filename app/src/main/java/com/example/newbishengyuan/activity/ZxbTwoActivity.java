 ...
 */
public class ZxbTwoActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.zhuxuebaoxiangqing_two);
        ...
        touzi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ZxbTwoActivity.this, PayActivity.class);
