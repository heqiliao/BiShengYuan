 ...
 */
public class ZxbOneActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.zhuxuebaoxiangqing_one);
        ...
        touzi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ZxbOneActivity.this,PayActivity.class);
